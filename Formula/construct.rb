class Construct < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/geraldmaron/construct/releases/download/v1.0.9/construct-darwin-arm64"
      sha256 "ba5489f713119179d970eae82c6026fea260af4ee7e7ccd23081430f3f063ccf"
    end
    on_intel do
      url "https://github.com/geraldmaron/construct/releases/download/v1.0.9/construct-darwin-x64"
  ...
  on_linux do
    on_arm do
      url "https://github.com/geraldmaron/construct/releases/download/v1.0.9/construct-linux-arm64"
      sha256 "d8414d95b616083579501e15017d816ccd8911acae1ca3815f24ea1f47a6dc71"
    end
    on_intel do
      url "https://github.com/geraldmaron/construct/releases/download/v1.0.9/construct-linux-x64"
